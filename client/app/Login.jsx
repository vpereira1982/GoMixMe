  ...
  <div className="col-md-4 col-md-offset-4 login bg-primary">
    ...
    <form onSubmit={props.handleSubmit}>
      <div className="form-group">
        <input className="form-control form-control-lg" value={props.email} onChange={props.handleChange} type="text" name="email" placeholder="Email" />
      </div>
      <div className="form-group">
        <input className="form-control form-control-lg" value={props.pw} onChange={props.handleChange} type="password" name="pw" placeholder="Password" />
      </div>
      <br />
